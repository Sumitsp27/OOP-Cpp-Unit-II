...
2.Protected Member Access Demonstrates the use of the protected access specifier and shows how a derived class can access protected members of its base class..

Public vs Private Inheritance
Demonstrates public and private inheritance modes and their effect on accessibility of inherited members.

Multilevel Inheritance Demonstrates a three-level inheritance hierarchy: Person → Employee → Manager
